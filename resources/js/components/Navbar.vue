...
const navigation = [
  ...
  { name: 'Cuestionarios', href: '/questionnaire', current: false, icon: QuestionMarkCircleIcon },
  { name: 'Preguntas', href: '/question', current: false, icon: AcademicCapIcon },
  { name: 'Respuestas', href: '/answer', current: false, icon: Bars3Icon },
  { name: 'Informes', href: '/report', current: false, icon: CalendarDaysIcon },
]
